...
def demo(image_name,image_no,image_index,net):
    ...
    plt.savefig('/media/sadaf/e4da0f25-29be-4c9e-a432-3193ff5f5baf/Code/AWA_data/Animals_with_Attributes2/clean_images_1/clean_bb{}.jpg'.format(image_no), dpi = 1500)
