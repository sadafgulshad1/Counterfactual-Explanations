...
def load_image_ids(split_name):
    ...
    if split_name == 'cub':
      folder_train='/media/sadaf/e4da0f25-29be-4c9e-a432-3193ff5f5baf/Code/Fine_Tune_Birds/trainval_split/'
	  #folder_val='/media/sadaf/e4da0f25-29be-4c9e-a432-3193ff5f5baf/Code/Fine_Tune_Birds/val_split'
	  #folder_test='/media/sadaf/e4da0f25-29be-4c9e-a432-3193ff5f5baf/Code/Fine_Tune_Birds/test_split'
      split_temp,split_temp_name=load_imageid(folder_train)
      for i in range (len(split_temp)):
        split.append((os.path.join(folder_train,split_temp_name[i]),split_temp[i]))
    
    if split_name == 'coco_test2014':
      with open('/media/sadaf/e4da0f25-29be-4c9e-a432-3193ff5f5baf/Code/bottom-up-attention/data/coco/annotations/image_info_test2014.json') as f:
        data = json.load(f)
        for item in data['images']:
           #print(item)
           image_id = int(item['id'])
           print(item['file_name'])
           filepath = os.path.join('/media/sadaf/e4da0f25-29be-4c9e-a432-3193ff5f5baf/Code/bottom-up-attention/data/test2014/', item['file_name'])
