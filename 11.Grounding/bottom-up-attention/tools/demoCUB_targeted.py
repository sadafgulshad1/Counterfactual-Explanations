...
att_index=[]
att_cls=[]
with open('/media/sadaf/e4da0f25-29be-4c9e-a432-3193ff5f5baf/Code/Pytorch_Code/transfer_learn/Targeted_attacks/ground_clean_attr_25.txt') as inputfile:
...
att_index_adv=[]
att_cls_adv=[]
with open('/media/sadaf/e4da0f25-29be-4c9e-a432-3193ff5f5baf/Code/Pytorch_Code/transfer_learn/Targeted_attacks/ground_adv_attr_25.txt') as inputfile:
    for row in csv.reader(inputfile):
...
def demo(image_name,image_no,net):
    ...
    im = cv2.imread(os.path.join("/media/sadaf/e4da0f25-29be-4c9e-a432-3193ff5f5baf/Code/Pytorch_Code/transfer_learn/Targeted_attacks/adv_images",image_name))
    ...
    plt.savefig('/media/sadaf/e4da0f25-29be-4c9e-a432-3193ff5f5baf/Code/Pytorch_Code/transfer_learn/Targeted_attacks/adv_bb/adv_bb{}_25.jpg'.format(image_no), dpi = 1500) 
...
file_names=[sorted(glob.glob( os.path.join("/media/sadaf/e4da0f25-29be-4c9e-a432-3193ff5f5baf/Code/Pytorch_Code/transfer_learn/Targeted_attacks/adv_images", '*.jpg') ),key=lambda x:float(re.findall("([0-9]+?)\.jpg",x)[0]))]
image_name=[]
image_no=[]
#import zip
