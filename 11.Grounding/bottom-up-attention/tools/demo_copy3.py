###Code without condition on removing similar attributes###
...
for i in range(len(keep_boxes)):
    ...
    if attr_conf[i] > attr_thresh:
        ...
        plt.savefig('/home/sadaf/bottom-up-attention/tools/adv_bb/adv_bb3957_50.jpg')
        #plt.savefig('/home/sadaf/bottom-up-attention/tools/clean_bb/clean_bb3957_50.jpg') 
