...
wrong_cls=[]
##############################################
with open('/media/sadaf/e4da0f25-29be-4c9e-a432-3193ff5f5baf/Code/Pytorch_Code/transfer_learn/Analysis/discriminative_attr_class_all.txt') as inputfile:
...
att_index=[]
att_cls=[]
with open('/media/sadaf/e4da0f25-29be-4c9e-a432-3193ff5f5baf/Code/Pytorch_Code/transfer_learn/Analysis/ground_clean_attr_50.txt') as inputfile:
    for row in csv.reader(inputfile):
...
for i in range (len(att_names)/no_of_images):
...
att_index_adv=[]
att_cls_adv=[]
with open('/media/sadaf/e4da0f25-29be-4c9e-a432-3193ff5f5baf/Code/Pytorch_Code/transfer_learn/Analysis/ground_adv_attr_50.txt') as inputfile:
    for row in csv.reader(inputfile):
...
for i in range (len(att_names_adv)/no_of_images):
...
def demo(image_name,image_no,net):
    colors=["blue","green","red","cyan","magenta","yellow","black","white","darkblue","orchid","springgreen","lime","deepskyblue","mediumvioletred","maroon","orangered", "navy", "olive", "orange","orangered","orchid","pink", "plum","purple","salmon", "sienna", "silver","tan","teal","tomato","violet","wheat","yellow","yellowgreen","lavender","palevioletred"]
    ...
    im = cv2.imread(os.path.join("/media/sadaf/e4da0f25-29be-4c9e-a432-3193ff5f5baf/Code/Pytorch_Code/transfer_learn/Analysis/clean_images",image_name))
    cls_append=[]
    ...
    plt.savefig('/media/sadaf/e4da0f25-29be-4c9e-a432-3193ff5f5baf/Code/Pytorch_Code/transfer_learn/Analysis/adv_bb1_ground_clean_/adv_bb_clean{}.jpg'.format(image_no), dpi = 1500) 
...
file_names=[sorted(glob.glob( os.path.join("/media/sadaf/e4da0f25-29be-4c9e-a432-3193ff5f5baf/Code/Pytorch_Code/transfer_learn/Analysis/clean_images/", '*.jpg')),key=lambda x:float(re.findall("([0-9]+?)\.jpg",x)[0]))]
"""
for i in range (len(wrong_cls)):
    #file_names=[sorted(glob.glob( os.path.join("/media/sadaf/e4da0f25-29be-4c9e-a432-3193ff5f5baf/Code/Pytorch_Code/transfer_learn/data/test_split/wrong_cls[i]/", '*.jpg')),key=lambda x:float(re.findall("([0-9]+?)\.jpg",x)[0]))]
    file_path=os.path.join("/media/sadaf/e4da0f25-29be-4c9e-a432-3193ff5f5baf/Code/Pytorch_Code/transfer_learn/data/test_split/",wrong_cls[i])
    random_filename=(random.choice([
    x for x in os.listdir(file_path)
    if os.path.isfile(os.path.join(file_path, x))]))
    file_names.append([sorted(glob.glob( os.path.join(file_path, random_filename)),key=lambda x:float(re.findall("([0-9]+?)\.jpg",x)[0]))]  )
