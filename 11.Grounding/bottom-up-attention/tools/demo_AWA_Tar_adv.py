...
def demo(image_name,image_no,image_index,net):
    ...
    im = cv2.imread(os.path.join("/media/sadaf/e4da0f25-29be-4c9e-a432-3193ff5f5baf/Code/AWA_data/Animals_with_Attributes2/targeted_attacks/adv_images",image_name))
    cls_append=[]
    ...
    plt.savefig('/media/sadaf/e4da0f25-29be-4c9e-a432-3193ff5f5baf/Code/AWA_data/Animals_with_Attributes2/targeted_attacks/adv_bb/Adv_bb{}.jpg'.format(image_index), dpi = 1500)
...
file_names=[sorted(glob.glob("/media/sadaf/e4da0f25-29be-4c9e-a432-3193ff5f5baf/Code/AWA_data/Animals_with_Attributes2/targeted_attacks/adv_images/*.jpg"),key=lambda x:float(re.findall("([0-9]+?)\.jpg",x)[0]))]
