...
wrong_cls=[]
##############################################
with open('/media/sadaf/e4da0f25-29be-4c9e-a432-3193ff5f5baf/Code/Pytorch_Code/transfer_learn/pytorch-cw2/discriminative_attr_class_all.txt') as inputfile:
...
att_index=[]
att_cls=[]
with open('/media/sadaf/e4da0f25-29be-4c9e-a432-3193ff5f5baf/Code/Pytorch_Code/transfer_learn/pytorch-cw2/ground_clean_attr_50.txt') as inputfile:
    for row in csv.reader(inputfile):
...
att_index_adv=[]
att_cls_adv=[]
with open('/media/sadaf/e4da0f25-29be-4c9e-a432-3193ff5f5baf/Code/Pytorch_Code/transfer_learn/pytorch-cw2/ground_adv_attr_50.txt') as inputfile:
    for row in csv.reader(inputfile):
...
def demo(image_name,image_no,net):
    ...
    im = cv2.imread(os.path.join("/media/sadaf/e4da0f25-29be-4c9e-a432-3193ff5f5baf/Code/Pytorch_Code/transfer_learn/pytorch-cw2/clean_images",image_name))
    cls_append=[]
    ...
    plt.savefig('/media/sadaf/e4da0f25-29be-4c9e-a432-3193ff5f5baf/Code/Pytorch_Code/transfer_learn/pytorch-cw2/clean_bb/clean_bb{}.jpg'.format(image_no), dpi = 1500) 
...
file_names=[sorted(glob.glob( os.path.join("/media/sadaf/e4da0f25-29be-4c9e-a432-3193ff5f5baf/Code/Pytorch_Code/transfer_learn/pytorch-cw2/clean_images", '*.jpg') ),key=lambda x:float(re.findall("([0-9]+?)\.jpg",x)[0]))]
image_name=[]
image_no=[]
#import zip
